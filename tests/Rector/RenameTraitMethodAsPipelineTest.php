...
/**
 * End-to-end: the rename-trait-method-as transform driving the real Rector binary (ADR-0006).
 */
#[CoversClass(RenameTraitMethodAsRector::class)]
#[UsesClass(Interpreter::class)]
#[UsesClass(TransformResolver::class)]
#[UsesClass(RenameTraitMethodAs::class)]
#[UsesClass(CompiledRule::class)]
#[UsesClass(DslConfigAssembler::class)]
#[UsesClass(Runner::class)]
#[UsesClass(FileChange::class)]
final class RenameTraitMethodAsPipelineTest extends TestCase
{
    private string $workspace;

    protected function setUp(): void
    {
        $this->workspace = sys_get_temp_dir() . '/consult-rector-rename-trait-' . uniqid('', true);
    ...
    public function testAddsARenameAdaptationAlias(): void
    {
        ...
        self::assertStringContainsString('record', $change->diff);
        self::assertContains(RenameTraitMethodAsRector::class, $change->appliedRules);
    }
}
